...
import LocationGreen from "../assets/svg/location_green.svg"
                ...
                {keyData?.map((result, index) => {
                    return (
                        <View style={{ flexDirection: "row", alignItems: "center", marginTop: 10 }}>
                            <View
                                style={{ backgroundColor: "white", borderWidth: StyleSheet.hairlineWidth, elevation: 4, borderColor: "#707070", height: 40, justifyContent: "center", alignItems: "center", width: 40, borderRadius: 50, marginLeft: 10 }}>
                            ...
                            <View style={{ flex: 9 }}>
                                <Text style={{ fontWeight: "700", marginLeft: 10, marginRight: 2, color: "#A1A1A1", fontSize: 16 }}>{result.desc}</Text>
                            </View>
                        </View>
                    )
                })}
